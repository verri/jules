...
template <typename T> using extents = decltype(std::declval<const T&>().extents());
...
template <typename T, typename> struct CommonArray : std::false_type {
};
...
struct CommonArray<                                                                                    //
  T, meta::requires<                                                                                   //
       ...
       meta::compiles_same<T, std::array<typename T::size_type, T::order>, meta::result::extents>,     //
