...
{
  using jules::detail::identity_mapper;
  ...
  auto v = jules::strided_ref_array<double, 1u, identity_mapper<1>>(x.data(), {{0u, {{x.size()}}}});
  ...
  auto w = jules::strided_ref_array<const double, 1u, identity_mapper<1>>(x.data(), {{0u, {{x.size() / 2u}}, {{2u}}}});
  ...
  auto a = jules::strided_ref_array<double, 1u, identity_mapper<1>>(x.data(), {{0u, {{x.size()}}}});
  auto b = jules::strided_ref_array<double, 1u, identity_mapper<1>>(y.data(), {{0u, {{y.size()}}}});
  ...
  auto c = jules::strided_ref_array<double, 2u, identity_mapper<2>>(x.data(), {{0u, {{x.size() / 2, 2u}}}});
