...
---
  ...
  - `jules`
      ...
      - [random\_engine](doc_base__random.html#base/random.hpp "jules::random_engine")
      ...
      - [sample(index\_t, Dist &)](doc_base__random.html#base/random.hpp "jules::sample(index_t, Dist &)")
    
      - [seq(const index\_t, const index\_t, const distance\_t)](doc_array__numeric.html#array/numeric.hpp "jules::seq(const index_t, const index_t, const distance_t)")
    
      - [slice](doc_array__slice.html#array/slice.hpp "jules::slice")
    
      - [square(const T &)](doc_base__numeric.html#base/numeric.hpp "jules::square(const T &)")
  ...
  - `jules::blas`
      ...
      - [cblas](doc_array__blas.html#array/blas.hpp "jules::blas::cblas\<T\>")
    
      - [cblas\<double\>](doc_array__blas.html#array/blas.hpp "jules::blas::cblas\<double\>")
    
      - [cblas\<float\>](doc_array__blas.html#array/blas.hpp "jules::blas::cblas\<float\>")
  ...
  - `jules::detail`
      ...
      - [do\_slice(const std::array\<index\_t, N\> &, std::vector\<index\_t\> &, const base\_slice\<N\> &, std::array\<index\_t, D\>)](doc_array__detail__slicing.html#array/detail/slicing.hpp "jules::detail::do_slice(const std::array\<index_t, N\> &, std::vector\<index_t\> &, const base_slice\<N\> &, std::array\<index_t, D\>)")
      ...
      - [extents(base\_slice\<N\> &)](doc_array__detail__slicing.html#array/detail/slicing.hpp "jules::detail::extents(base_slice\<N\> &)")
  ...
  - `jules::meta`
      ...
      - [bool\_constant](doc_core__meta.html#core/meta.hpp "jules::meta::bool_constant\<B\>")
    
      - [compiles\<T, Expression, void\_t\<Expression\<T\>\>\>](doc_core__meta.html#core/meta.hpp "jules::meta::compiles\<T, Expression, void_t\<Expression\<T\>\>\>")
    
      - [compiles](doc_core__meta.html#core/meta.hpp "jules::meta::compiles\<T, Expression\>")
    
      - [conjunction](doc_core__meta.html#core/meta.hpp "jules::meta::conjunction\<\>")
    
      - [conjunction\<B, Bs...\>](doc_core__meta.html#core/meta.hpp "jules::meta::conjunction\<B, Bs...\>")
    
      - [conjunction\<B\>](doc_core__meta.html#core/meta.hpp "jules::meta::conjunction\<B\>")
    
      - [fallback](doc_core__meta.html#core/meta.hpp "jules::meta::fallback\<Checks...\>")
    
      - [fallback\_t](doc_core__meta.html#core/meta.hpp "jules::meta::fallback_t\<R, Checks...\>")
    
      - [negation](doc_core__meta.html#core/meta.hpp "jules::meta::negation\<B\>")
    
      - [requires](doc_core__meta.html#core/meta.hpp "jules::meta::requires\<Checks...\>")
  ...
  - `ranges::v3::view`
      ...
      - [interval(T, T, T)](doc_core__range.html#core/range.hpp "ranges::v3::view::interval(T, T, T)")
    
      - [interval\_n(T, T, ::jules::index\_t)](doc_core__range.html#core/range.hpp "ranges::v3::view::interval_n(T, T, ::jules::index_t)")
    
      - [numbers(T, T)](doc_core__range.html#core/range.hpp "ranges::v3::view::numbers(T, T)")
    
      - [numbers\_n(T, ::jules::index\_t, T)](doc_core__range.html#core/range.hpp "ranges::v3::view::numbers_n(T, ::jules::index_t, T)")
